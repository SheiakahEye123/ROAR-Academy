...
trainingX = [samples[randomOrder[0:100], :], samples[randomOrder[0:100], :]]
trainingY = [labels[randomOrder[0:100], :],labels[randomOrder[0:100], :]]
testingX = [samples[randomOrder[100:200], :], samples[randomOrder[100:200], :]]
testingY = [labels[randomOrder[100:200], :], labels[randomOrder[100:200], :]]
...
model2.add(Dense(2, input_shape=(2), activation='sigmoid'))
...
model2.fit(trainingX, trainingY, epochs=500, batch_size=10, verbose=1, validation_split=0.2)
